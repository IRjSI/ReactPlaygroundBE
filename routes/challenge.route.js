...
import { createChallenge, getChallengeById, getChallenges, getUserChallenges } from "../controllers/challenge.controller.js";

const challengeRouter = express.Router();

challengeRouter.get('/get-challenges', verifyToken, getChallenges);
challengeRouter.get('/get-challenge/:challengeId', verifyToken, getChallengeById);
